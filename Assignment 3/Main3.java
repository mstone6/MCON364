...
public class Main3 {
    public static void main(String[]args){
        ...
        ArrayListHashMap<String, Integer> myMap = new ArrayListHashMap<String, Integer>();
                    ...
                    switch (function) {
                        ...
                        case 1:
                            ...
                            if (myMap.containsKey(word)) {
                                int naiveHashValue = naiveHash(word);
                        ...
                        case 2:
                            ...
                            if (myMap.containsKey(word2)) {
                                int sophisticatedHashVal = sophisticatedHash(word2);
    ...
    static void processWords(ArrayListHashMap<String, Integer> myMap){
    ...
    private static int naiveHash(String key){
        //This naive hash function sums up the ASCII values of the characters
        //and puts them into a string which is then hashed.
        int hash = 0;
    ...
    private static int sophisticatedHash(String key){
        //This hash function calculates the hash based on multiplication
        //The key is the input needing to be hashed
        int hash = 0;
        for (int i = 0; i < key.length(); i++) {
            hash = 31 * hash + key.charAt(i);
        }
        //Now returning the hash value of the input string
        return hash;
    }

    private static void printDescOrder(ArrayListHashMap<String, Integer> myMap){
        ...
        Iterator<MapEntry<String, Integer>> iterator = myMap.iterator();
    ...
    static void hashReportInternalStructure(ArrayListHashMap<String, Integer> myMap) {
        ...
        for (int i = 0; i < myMap.buckets.size(); i++) {
            List<MapEntry<String, Integer>> bucket = myMap.buckets.get(i);
